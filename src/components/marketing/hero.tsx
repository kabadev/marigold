    ...
    <div className="flex flex-col items-center text-center w-full max-w-5xl my-24 mx-auto z-40 relative">
      ...
      <Container delay={0.1}>
        <p className="text-sm sm:text-base lg:text-lg mt-4 text-accent-foreground/60 max-w-2xl mx-auto">
          Welcome to a safe and supportive platform built for women in Sierra
          Leone. Here, you can connect with a community, access essential
          resources, find job opportunities, and report issues with confidence
          and care.{" "}
          <span className="hidden sm:inline text-primary">
            Join us in fostering empowerment, resilience, and a brighter future
            for all.
          </span>
        </p>
      </Container>
